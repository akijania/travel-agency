...
class TripListOptions extends React.Component {
  ...
  handleDuration(type, value){
    ...
    if(type == 'to'){
      ...
      this.props.createActionChangeDurationTo(parsedValue);
    } else {
      this.props.createActionChangeDurationFrom(parsedValue);
    }
  }
  handleSearch(phrase){
...
TripListOptions.propTypes = {
  ...
  createActionChangeDurationTo: PropTypes.func,
  createActionChangeDurationFrom: PropTypes.func,
};
